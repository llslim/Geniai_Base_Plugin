...
class chat_3 extends external_api {
    ...
    public static function api_returns() {
        return new external_single_structure([
            ...
            "builder_json" => new external_value(PARAM_RAW, "Generated scenario JSON from the AI builder", VALUE_OPTIONAL),
        ]);
    }
    ...
    public static function api($message, $courseid, $audio = null, $lang = null) {
        return \local_aacuracore\api::chat_api($message, $courseid, $audio, $lang);
    }
}
