        ...
        readmore: function() {
            ...
            function createReadMore($lement) {
                ...
                if (fullText.length > maxLength) {
                    ...
                    var readmore = `<span class="btn btn-link readmore-link">${M.util.get_string("h5p-readmore", "local_aacuracore")}</span>`;
            ...
            $("#h5p-create-new-link").click(function() {
                ModalFactory.create({
                    ...
                    title: M.util.get_string("h5p-page-title", "local_aacuracore"),
